		...
		try {
			...
			if (!(thanks.equalsIgnoreCase("null"))) {
				...
				if (!(filltypeintent.equalsIgnoreCase("null"))) {
					...
					// service call for form link
					// AEMService aemService = new AEMService();
					// String formUrl = aemService.getCardRegisterFormLink("sumit", "uppal",
					// "224-381-4567", "abc@cap.com", "air india");
...
//						      card = new Card(objectInArray.getString("product_name"), objectInArray.getString("thumbnail_path"));
//						      cardList.add(card);
//						      System.out.println();
//						    }
