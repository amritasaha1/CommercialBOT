...
import com.amazonaws.lambda.demo.BasicAuthRestTemplate;
...
//    	return (String[]) elements.toArray();
	...
	public JSONArray getCreditCardOffers(){
    	...
    	JSONObject bodyObj = getServiceResponse("http://54.195.246.137/services/GetProducts?query=cards");
    ...
    public String getCardRegisterFormLink(String fName, String lName, String phoneNo, String emailId, String preference) {
    	...
    	String formServiceURL = "http://54.195.246.137/services/getApplyNow?" + paramString;
